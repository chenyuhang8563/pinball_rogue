extends RefCounted
class_name VenomKnifeEffect

const StatModifierScript: GDScript = preload("res://Core/stats/stat_modifier.gd")
const DEFAULT_CONFIG: RelicLevelConfig = preload("res://Content/data/relic_configs/venom_knife.tres")
const ENTITY_ID: String = "marble_chain"
const STAT_ID: String = "poison_stacks_per_hit"
const MODIFIER_ID: String = "relic_upgrade:venom_knife"
