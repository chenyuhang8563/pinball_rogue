extends RefCounted
class_name WitchHatEffect

const StatModifierScript: GDScript = preload("res://Core/stats/stat_modifier.gd")
const DEFAULT_CONFIG: RelicLevelConfig = preload("res://Content/data/relic_configs/witch_hat.tres")
const ENTITY_ID: String = "marble_chain"
const STAT_ID: String = "poison_max_stacks"
const MODIFIER_ID: String = "relic_upgrade:witch_hat"
