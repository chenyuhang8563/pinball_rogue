...
const AimIndicatorScene: PackedScene = preload("res://Combat/skills/MagicMissile/magic_missile_aim_indicator.tscn")
const MissileScene: PackedScene = preload("res://Combat/skills/MagicMissile/magic_missile.tscn")
